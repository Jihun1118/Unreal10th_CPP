...
public:
	...
	void SpawnPickupAsync(const UItemDataAsset* InItemDataAsset, const FTransform& InTransform,
		FOnPickupSpawned OnSpawned);

	UFUNCTION(BlueprintCallable, Category = "Factory|Pickup", meta = (DisplayName = "Spawn Pickup Async"))
	void K2_SpawnPickupAsync(const UItemDataAsset* InItemDataAsset, const FTransform& InTransform,
